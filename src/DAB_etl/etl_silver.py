...
dlt.create_auto_cdc_flow(
    ...
    source="surakshadb.db_stg.br_acxtestdone",
    keys=["SALESID", "ITEMID"],
...
def sil_doctorattendance():
    return dlt.read_stream("surakshadb.db_stg.br_doctorattendance")
...
def sil_routinetests():
    return dlt.read_stream("surakshadb.db_stg.br_routinetests")
...
dlt.create_auto_cdc_flow(
    ...
    source="surakshadb.db_stg.br_patientsdata",
    keys=["Patient_ID"],
